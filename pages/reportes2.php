			...
			<div class="row">
				<div class="col-lg-12">
					...
					<div class="input-daterange input-group mb-4" id="datepicker">
						De:
						<input type="text" class="input-sm form-control border-bottom border rounded" id="start_date" name="start_date" />
						<span class="input-group-addon">a: </span>
						<input type="text" class="input-sm form-control border rounded" id="end_date" name="end_date" />
					</div>
